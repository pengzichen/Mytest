                    ...
                    <div class="table-box">
                            ...
                            <c:forEach var="product" items="${pageInfo.list}">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button onclick='location.href="/pages/deit.jsp"' type="button" class="btn bg-olive btn-xs">编辑</button>
                                        <button onclick='location.href="/deit.jsp"' type="button" class="btn bg-olive btn-xs">详情</button>
                                        <button onclick='location.href="/deit.jsp"' type="button" class="btn bg-olive btn-xs">订单</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            <!-- <tr>
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick='location.href="all-travellog-manage-edit.html"'><i
                                            class="fa fa-file-o"></i> 新建
                                    </button>
                                    <button type="button" class="btn btn-default" title="删除"
                                            onclick='confirm("你确认要删除吗？")'><i class="fa fa-trash-o"></i> 删除
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pages">
                                <li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pages}&size=${pageInfo.pageSize}">${pages}</a></li>
                            </c:forEach>
